...
{
    // In this scene, we will see the three penguins on the rail, 
    // then we turn the camera to see the other penguin on the other rail.
    // We see panic in the eyes of the penguin on the other rail.
    ...
    tcube->addLocalTransformKeyframe(getTranslationMatrix(0,-5,0)*getScaleMatrix(1000,1,1000),0);
    tcube->addLocalTransformKeyframe(getTranslationMatrix(0,-5,0)*getScaleMatrix(1000,1,1000),10);
    tcube->addGlobalTransformKeyframe(getTranslationMatrix(0,2,-0.5),0);
    tcube->addGlobalTransformKeyframe(getTranslationMatrix(0,2,-0.5),2);
    tcube->addGlobalTransformKeyframe(getTranslationMatrix(0,1,-0.5),4);
    tcube->addGlobalTransformKeyframe(getRotationMatrix(-M_PI*0.15,glm::vec3(0,1,0)) * getTranslationMatrix(-1,1,-1.5),7);
    tcube->addGlobalTransformKeyframe(getRotationMatrix(-M_PI*0.15,glm::vec3(0,1,0))*getTranslationMatrix(-1,2,-1.5),9);
    tcube->addGlobalTransformKeyframe(getRotationMatrix(-M_PI*0.15,glm::vec3(0,1,0))*getTranslationMatrix(-1,2,-1.5),11);
    penguin1->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(4,0.5,-3),0);
    penguin1->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(4,0.5,-3)*getRotationMatrix(-M_PI*0.1,glm::vec3(0,1,0)),0.5);
    penguin1->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(4,0.5,-3)*getRotationMatrix(M_PI*0.1,glm::vec3(0,1,0)),1.5);
    penguin1->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(4,0.5,-3),2);
    penguin2->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(6,0.5,-3),0);
    penguin2->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(6,0.5,-3)*getRotationMatrix(M_PI*0.15,glm::vec3(0,1,0)),0.3);
    penguin2->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(6,0.5,-3)*getRotationMatrix(-M_PI*0.15,glm::vec3(0,1,0)),0.9);
    penguin2->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(6,0.5,-3),1.2);
    penguin3->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(8,0.5,-3),0);
    penguin3->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(8,0.5,-3)*getRotationMatrix(-M_PI*0.1,glm::vec3(0,1,0)),0.4);
    penguin3->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(8,0.5,-3)*getRotationMatrix(M_PI*0.1,glm::vec3(0,1,0)),1.2);
    penguin3->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(8,0.5,-3),1.6);
    penguin4->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(4,5,-3)*getRotationMatrix(M_PI*0.15, glm::vec3(0,0,1)),0);
    penguin4->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(4,5,-3)*getRotationMatrix(M_PI*0.15, glm::vec3(0,0,1))*getRotationMatrix(-M_PI*0.15,glm::vec3(0,1,0)),0.3);
    penguin4->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(4,5,-3)*getRotationMatrix(M_PI*0.15, glm::vec3(0,0,1))*getRotationMatrix(M_PI*0.15,glm::vec3(0,1,0)),0.9);
    penguin4->addGlobalTransformKeyframe(getRotationMatrix(M_PI, glm::vec3(0,1,0))*getRotationMatrix(M_PI*0.5, glm::vec3(-1,0,0))*getTranslationMatrix(4,5,-3)*getRotationMatrix(M_PI*0.15, glm::vec3(0,0,1)),1.2);
