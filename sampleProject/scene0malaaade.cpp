...
void initialize_scene( Viewer& viewer )
{
	...
	traing->addLocalTransformKeyframe(glm::vec3(0),0/0.3);
	traing->addLocalTransformKeyframe(getRotationMatrix(M_PI/6, glm::vec3(0,0,1)),1/0.3);
	traing->addLocalTransformKeyframe(getRotationMatrix(M_PI/2, glm::vec3(0,0,1)),3/0.3);
	traing->addLocalTransformKeyframe(getRotationMatrix(M_PI/3, glm::vec3(0,0,1)),2/0.3);
	traing->addLocalTransformKeyframe(getRotationMatrix(M_PI*2/3, glm::vec3(0,0,1)),4/0.3);
	traing->addLocalTransformKeyframe(getRotationMatrix(M_PI*5/6, glm::vec3(0,0,1)),5/0.3);
	traing->addLocalTransformKeyframe(getRotationMatrix(M_PI*2/3, glm::vec3(0,0,1)),6/0.3);
	traing->addLocalTransformKeyframe(getRotationMatrix(M_PI/2, glm::vec3(0,0,1)),7/0.3);
	traing->addLocalTransformKeyframe(getRotationMatrix(M_PI/3, glm::vec3(0,0,1)),8/0.3);
	traing->addLocalTransformKeyframe(getRotationMatrix(M_PI/6, glm::vec3(0,0,1)),9/0.3);
	traing->addLocalTransformKeyframe(glm::vec3(0),10/0.3);
