	...
	: Renderable(shaderProgram), m_vBuffer(0), m_cBuffer(0)
{
	...
	m_colors = {
		glm::vec4(1, 0, 0, 1), glm::vec4(1, 0, 0, 1), glm::vec4(1, 0, 0, 1),
		glm::vec4(0, 1, 0, 1), glm::vec4(0, 1, 0, 1), glm::vec4(0, 1, 0, 1),
		glm::vec4(0, 0, 1, 1), glm::vec4(0, 0, 1, 1), glm::vec4(0, 0, 1, 1),
		glm::vec4(1, 1, 0, 1), glm::vec4(1, 1, 0, 1), glm::vec4(1, 1, 0, 1),
		glm::vec4(1, 0, 1, 1), glm::vec4(1, 0, 1, 1), glm::vec4(1, 0, 1, 1),
		glm::vec4(0, 1, 1, 1), glm::vec4(0, 1, 1, 1), glm::vec4(0, 1, 1, 1),
		glm::vec4(1, 1, 0, 1), glm::vec4(1, 1, 0, 1), glm::vec4(1, 1, 0, 1),
		glm::vec4(0, 1, 0, 1), glm::vec4(0, 1, 0, 1), glm::vec4(0, 1, 0, 1),
		glm::vec4(0, 1, 1, 1), glm::vec4(0, 1, 1, 1), glm::vec4(0, 1, 1, 1),
	};
